    ...
    void CreateRoom()
    {
        ...
        for (int x = 1; x < sizeX-1; x++)
        {
            for (int y = 1; y < sizeY-1; y++)
            {
                ...
                pav.transform.localScale = new Vector3(10, 20, 10);
                ...
                {
                    CreateWall(new Vector3(roomSize.x, wallHeight, 0.1f), new Vector3(0, wallHeight / 2, roomSize.y / 2), floor, wallMaterial);
                }
                ...
                {
                    CreateWall(new Vector3(0.1f, wallHeight, roomSize.y), new Vector3(-roomSize.y / 2, wallHeight / 2, 0), floor, wallMaterial);
                }
